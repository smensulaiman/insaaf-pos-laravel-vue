  ...
  !function (t, n) {
    ...
    return function () {
      ...
      function n(e, n) {
        ...
        e.handlers[n] && e.handlers[n] instanceof Array && t(e.handlers[n], function (e) {
      ...
      function a(a) {
        var o,
          ...
          d = function (e) {
            ...
            if (n.setAttribute("class", "tree-leaf"), a.setAttribute("class", "tree-leaf-content"), a.setAttribute("data-item", JSON.stringify(e)), o.setAttribute("class", "tree-leaf-text"), o.textContent = e.name, r.setAttribute("class", "tree-expando " + (e.expanded ? "expanded" : "")), r.textContent = e.expanded ? "-" : "+", a.appendChild(r), a.appendChild(o), n.appendChild(a), e.children && e.children.length > 0) {
              var l = document.createElement("div");
              l.setAttribute("class", "tree-child-leaves"), t(e.children, function (e) {
                var t = d(e);
                l.appendChild(t);
              }), e.expanded || l.classList.add("hidden"), n.appendChild(l);
            } else r.classList.add("hidden");
            return n;
          };
        t(a.data, function (e) {
          l.push(d.call(a, e));
        }), r.innerHTML = l.map(function (e) {
          return e.outerHTML;
        }).join(""), o = function (e) {
          ...
          r ? r.classList.contains("hidden") ? a.expand(t, r) : a.collapse(t, r) : n(a, "select", {
            target: e,
            data: o
          });
      ...
      return o.prototype.expand = function (e, t, a) {
        e.querySelector(".tree-expando").textContent = "-", t.classList.remove("hidden"), a || n(this, "expand", {
          target: e,
          leaves: t
        });
      }, o.prototype.expandAll = function () {
        var e = this;
        t(document.getElementById(e.node).querySelectorAll(".tree-expando"), function (t) {
          var n = t.parentNode,
        ...
        e.querySelector(".tree-expando").textContent = "+", t.classList.add("hidden"), a || n(this, "collapse", {
          target: e,
          leaves: t
        });
        ...
        var n,
          a = !1;
        this.handlers[e] instanceof Array && (this.handlers[e].forEach(function (e, o) {
