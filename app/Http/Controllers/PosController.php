...
class PosController extends BaseController
{
    ...
    public function getProductsByParameter(Request $request): JsonResponse
    {
        ...
        // How many items do you want to display.
        $perPage = PosSetting::query()->where('deleted_at', '=', null)->first()->products_per_page;
        ...
        $warehouseProductData = ProductWarehouse::query()
        ...
        $totalRows = $warehouseProductData->count();
        ...
        foreach ($warehouseProductData as $product_warehouse) {

            if ($product_warehouse->product_variant_id) {
                $productsVariants = ProductVariant::query()->where('product_id', $product_warehouse->product_id)
